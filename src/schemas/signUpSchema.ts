...
export const signUpSchema = object({
  ...
  member_1_grade: string()
    ...
    .refine(num => !(Number(num) < 9 || Number(num) > 13), { message: "9. és 13. évfolyam közötti diákok jelentkezhetnek" }),
  ...
  member_sub_grade: string().optional()
    ...
    .refine(num => num === undefined || num.trim().length === 0 || !(Number(num) < 9 || Number(num) > 13), { message: "9. és 13. évfolyam közötti diákok jelentkezhetnek" }),
  teachers: string(),
